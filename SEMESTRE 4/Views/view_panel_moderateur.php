...
<link rel="stylesheet" type="text/css" href="Content/css/modo.css"> <!-- C'EST LA Feuille de style pour la modération -->

<div class="container"> <!-- Conteneur principal -->
    <div class="container-trending"> <!-- Conteneur pour les éléments en tendance -->
        <div class="container-headline">
            <span class="material-symbols-outlined">add_moderator</span> <!-- Icône pour la modération -->
            Moderation
        </div>
        <div class="container-description">
            À modérer avec modération <!-- Description -->
        </div>
    </div>

    <header>
        <div class="tabs"> <!-- Onglets pour la navigation -->
    ...
    <div class="tab-content-wrapper">
        ...
        <!-- Contenu des onglets -->
        <div id="Formateurs" class="tabcontent"> <!-- Onglet pour les formateurs -->
            <div class="recent-orders">
                <table>
                    ...
                    <tbody>
                        <!-- Lignes de données pour les formateurs -->
                        <tr>
                            <td>Trizo</td>
                            <td>Mike</td>
                            <td>5</td>
                            <td><button class="butto"><span>Compétences</span></button></td>
                        </tr>
                        <tr>
                            <td>Grobide</td>
                            <td>Ravi</td>
        ...
        <div id="Discussions" class="tabcontent no">
            <div class="recent-orders">
                <table>
                    ...
                    <tbody>
                        <!-- Lignes de données pour les discussions -->
                        <tr>
                            <td>Settings</td>
                            <td>Tony</td>
                            <td>8</td>
                            <td><button class="butto bu"><span>Voir les discussions</span></button></td>
                        </tr>
                        <?php
        ...
        <div id="Utilisateurs" class="tabcontent no">
            <div class="recent-orders">
                <table>
                    ...
                    <tbody>
                        <!-- Lignes de données pour les utilisateurs -->
                        <?php
